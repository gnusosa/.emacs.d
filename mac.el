...
;; Add mu4e from mu HEAD formula in brew
(defconst mu-brew-path (concat "/usr/local/Cellar/mu/HEAD/share/emacs/site-lisp/"))
(add-to-list 'load-path mu-brew-path)
...
(global-set-key (kbd "M-s-<tab>") 'ns-next-frame)
...
(when window-system
  ...
  (setq magnars/presentation-font "-apple-Monaco-medium-normal-normal-*-14-*-*-*-m-0-iso10646-1")
